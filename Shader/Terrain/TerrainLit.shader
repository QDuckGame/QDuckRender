Shader "Custom/Terrain/Lit"
{
    Properties
    {
        ...
        _SplatBaseMapArray("Splat BaseMap Array", 2DArray) = "white" {}
        _NormalMaskArray("Normal Mask Array", 2DArray) = "white" {}
    ...
    SubShader
    {
        Tags { "Queue" = "Geometry-100" "RenderType" = "Opaque" "RenderPipeline" = "UniversalPipeline" "UniversalMaterialType" = "Lit" "IgnoreProjector" = "False" "TerrainCompatible" = "True" "SplatCount" = "6"}
